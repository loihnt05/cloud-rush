...
describe('payment suceessful', function() {
  this.timeout(60000)
  let driver
  let vars
  ...
  it('payment suceessful', async function() {
    ...
    {
      const element = await driver.findElement(By.css(".relative:nth-child(2) > .h-12"))
    ...
    await driver.findElement(By.css(".md\\3A col-span-2:nth-child(3) > .file\\3Atext-foreground")).sendKeys("xyz")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(5) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(5) > .file\\3Atext-foreground")).sendKeys("2025-12-08")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(6) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(6) > .file\\3Atext-foreground")).sendKeys("example@gmail.com")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(7) > .file\\3Atext-foreground")).sendKeys("1234567890")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(1) > .file\\3Atext-foreground")).sendKeys("xyz")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(2) > .file\\3Atext-foreground")).sendKeys("abc")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(3) > .file\\3Atext-foreground")).sendKeys("example@yahoo.com")
    ...
    await driver.wait(
      until.elementLocated(By.css(".space-y-4 > div:nth-child(1) > .w-full")),
      10000
    )
    console.log('✓ Payment form loaded')
    
    await driver.findElement(By.css(".space-y-4 > div:nth-child(1) > .w-full")).click()
    await driver.findElement(By.css(".space-y-4 > div:nth-child(1) > .w-full")).sendKeys("1213 1241 2412 4124")
    await driver.findElement(By.css(".space-y-4 > div:nth-child(2) > .w-full")).sendKeys("teo")
    await driver.findElement(By.css(".grid > div:nth-child(1) > .w-full")).sendKeys("34/33")
    await driver.findElement(By.css(".grid > div:nth-child(2) > .w-full")).sendKeys("123")
