...
describe('declined', function() {
  ...
  it('declined', async function() {
    ...
    {
      const element = await driver.findElement(By.css(".relative:nth-child(1) > .h-12"))
    ...
    await driver.findElement(By.css("#radix-\\3Ar15\\3A > .flex > .text-sm")).click()
    ...
    await driver.findElement(By.css(".md\\3A col-span-2:nth-child(1) > .file\\3Atext-foreground")).sendKeys("sbs")
    await driver.findElement(By.css(".md\\3A col-span-2:nth-child(2) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-2:nth-child(3) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-2:nth-child(3) > .file\\3Atext-foreground")).sendKeys("sdbd")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(5) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(5) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(5) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(5) > .file\\3Atext-foreground")).sendKeys("2025-12-09")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(6) > .file\\3Atext-foreground")).click()
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(6) > .file\\3Atext-foreground")).sendKeys("rc@gmail.com")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(7) > .file\\3Atext-foreground")).sendKeys("2352352353235")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(1) > .file\\3Atext-foreground")).sendKeys("teo")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(2) > .file\\3Atext-foreground")).sendKeys("em")
    await driver.findElement(By.css(".md\\3A col-span-3:nth-child(3) > .file\\3Atext-foreground")).sendKeys("eam@yahoo.com")
    ...
    for (const selector of phoneSelectors) {
      try {
        ...
        await emergencyPhone.sendKeys("3453535354345")
    ...
    assert(await driver.switchTo().alert().getText() == "Booking saved! You can complete payment later from My Bookings.")
    await driver.findElement(By.css(".rounded-lg:nth-child(3)")).click()
    await driver.findElement(By.css(".bg-card:nth-child(1) .flex > .inline-flex")).click()
    await driver.findElement(By.css(".dark\\3Ahover\\3A bg-accent\\/50")).click()
  })
})
