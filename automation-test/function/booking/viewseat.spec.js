...
describe('view seat', function() {
  ...
  it('view seat', async function() {
    ...
    await driver.findElement(By.css("#radix-\\3Arp\\3A > .flex > .text-sm")).click()
    ...
    await driver.findElement(By.id("radix-:r2n:")).click()
    ...
    await driver.findElement(By.css(".file\\3Atext-foreground")).sendKeys("2025-12-15")
