...
import { FaEnvelope, FaFileAlt, FaPalette, FaQuestionCircle, FaSignOutAlt } from "react-icons/fa";
        ...
        >
          <div className="bg-card border-2 border-primary/20 rounded-2xl shadow-2xl overflow-hidden w-100">
            ...
            <div className="bg-linear-to-br from-[#07401F] via-[#224A33] to-[#357D52] p-6">
              <div className="flex items-center gap-4">
                {user?.picture ? (
                  ...
                  <div className="w-16 h-16 rounded-full bg-white border-4 border-white shadow-lg flex items-center justify-center text-2xl font-bold text-primary">
                    {user?.name ? user.name.split(" ").map(n => n[0]).slice(0, 2).join("") : "U"}
                  </div>
                )}
            ...
            <div className="p-3 bg-muted/30">
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary/10 transition-all duration-200 group">
              ...
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary/10 transition-all duration-200 group">
                ...
                <div className="flex-1 text-left">
                  <p className="font-semibold text-foreground">Change Theme</p>
              ...
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary/10 transition-all duration-200 group">
                ...
                <div className="flex-1 text-left">
                  <p className="font-semibold text-foreground">Send Report</p>
