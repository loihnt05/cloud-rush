    ...
    <div className="bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-[#148C56] dark:text-[#148C56] mb-6">Our Mission</h2>
          ...
          <div className="bg-linear-to-br from-[#148C56]/10 to-[#07401F]/10 rounded-2xl p-8">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl text-[#148C56] mb-2">Global Reach</h3>
                  <p className="text-foreground/70">Access to destinations worldwide with local expertise</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-[#148C56] p-3 rounded-lg">
                ...
                <div>
                  <h3 className="font-bold text-xl text-[#148C56] mb-2">Personalized Service</h3>
                  <p className="text-foreground/70">Tailored recommendations based on your preferences</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-[#148C56] p-3 rounded-lg">
                ...
                <div>
                  <h3 className="font-bold text-xl text-[#148C56] mb-2">Secure & Reliable</h3>
                  <p className="text-foreground/70">Safe booking with 24/7 customer support</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-muted/30 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-[#148C56] mb-12">
            What We Offer
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-card text-card-foreground rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-border">
              ...
              <h3 className="text-xl font-bold text-[#148C56] mb-3">Flights</h3>
            ...
            <div className="bg-card text-card-foreground rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-border">
              ...
              <h3 className="text-xl font-bold text-[#148C56] mb-3">Hotels</h3>
              <p className="text-foreground/70">
            ...
            <div className="bg-card text-card-foreground rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-border">
              ...
              <h3 className="text-xl font-bold text-[#148C56] mb-3">Car Rentals</h3>
              <p className="text-foreground/70">
            ...
            <div className="bg-card text-card-foreground rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-border">
              ...
              <h3 className="text-xl font-bold text-[#148C56] mb-3">Packages</h3>
              <p className="text-foreground/70">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="p-8">
            ...
            <p className="text-xl text-foreground/70">Happy Travelers</p>
          </div>
          <div className="p-8">
            <div className="text-5xl font-bold text-[#148C56] mb-2">150+</div>
            <p className="text-xl text-foreground/70">Destinations</p>
          </div>
          <div className="p-8">
            <div className="text-5xl font-bold text-[#148C56] mb-2">98%</div>
            <p className="text-xl text-foreground/70">Satisfaction Rate</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <h2 className="text-4xl font-bold text-[#148C56] mb-6">
