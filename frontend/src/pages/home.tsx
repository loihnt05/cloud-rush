        ...
        <section className="py-20 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Flight Bookings */}
              <div className="group p-6 rounded-2xl border-2 border-border hover:border-sky-200 hover:shadow-xl transition-all duration-300 bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Flight Bookings</h3>
              ...
              <div className="group p-6 rounded-2xl border-2 border-border hover:border-sky-200 hover:shadow-xl transition-all duration-300 bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Hotels</h3>
                <p className="text-foreground/70">
              ...
              <div className="group p-6 rounded-2xl border-2 border-border hover:border-sky-200 hover:shadow-xl transition-all duration-300 bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Car Rentals</h3>
                <p className="text-foreground/70">
              ...
              <div className="group p-6 rounded-2xl border-2 border-border hover:border-sky-200 hover:shadow-xl transition-all duration-300 bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Travel Packages</h3>
                <p className="text-foreground/70">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-foreground mb-1">Explore Destinations</h3>
                      <p className="text-foreground/70">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-foreground mb-1">Trip Planning Made Easy</h3>
                      <p className="text-foreground/70">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-foreground mb-1">Secure & Reliable</h3>
                      <p className="text-foreground/70">
              ...
              <div className="relative">
                <div className="aspect-square rounded-2xl bg-linear-to-br from-sky-400 via-blue-500 to-purple-600 p-8 shadow-2xl">
                  <div className="w-full h-full bg-background rounded-xl p-8 flex items-center justify-center">
                    <div className="text-center">
        ...
        <section className="py-20 bg-linear-to-r from-sky-600 to-blue-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Button
              size="lg"
              onClick={() => loginWithRedirect({ authorizationParams: { screen_hint: "signup" } })}
              className="bg-background text-sky-600 hover:bg-muted text-lg px-8 py-6"
            >
              Sign Up for Free
            </Button>
          </div>
